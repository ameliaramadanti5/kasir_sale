...
<head>
    ...
    <title>APLIKASI KASIR-Amel</title>
...
<body class="hold-transition skin-green sidebar-mini <?=$this->uri->segment(1) == 'sale' ? 'sidebar-collapse' : null?>">
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?= base_url('dashboard')?>" class="logo">
                ...
                <span class="logo-lg"><b>The</b>SHOP</span>
            </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy;Amelia Ramadanti <a href="https://rmdnttt.id"></a>.</strong> All rights reserved.
    </footer>
